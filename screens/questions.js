...
export function renderQuestionsScreen() {
  ...
  // If premium, set energy from state (default medium)
  const energyEl = document.getElementById("energySelect");
  if (energyEl) {
    energyEl.value = state.energy || "medium";
  }
  ...
  document.getElementById("nextBtn").addEventListener("click", () => {
    ...
    // Default energy for free users
    let energy = "medium";
    const e = document.getElementById("energySelect");
    if (e) energy = e.value;
...
// Helper MUST be outside renderQuestionsScreen
